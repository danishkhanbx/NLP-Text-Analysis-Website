...
from sumy.summarizers.lsa import LsaSummarizer  # You can choose different summarization algorithms from sumy
...
def summarize():
    ...
    if len(sent) < 2:
        ...
        summarizer = LsaSummarizer()  # You can change this to other summarizers
        summary = summarizer(parser.document, 2)  # You can change the number of sentences in the summary
